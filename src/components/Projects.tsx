...
const fallbackProjects: Project[] = [
  {
    ...
    description: 'A high-end visual identity experience with immersive motion and thoughtful product storytelling.',
  },
  {
    title: 'Nova Commerce',
    ...
    year: '2024',
    tools: ['Next.js', 'Supabase', 'UI/UX'],
    description: 'A premium commerce storefront built for conversion, speed, and modern brand expression.',
  },
  {
    title: 'Lumen Studio',
    ...
    year: '2024',
    tools: ['Figma', 'TypeScript', 'GSAP'],
    description: 'Smart interactions and a polished experience that makes every feature feel effortless.',
  },
];
